        ...
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">
              TRANSFORMING RETAIL PAYMENTS CUSTOMER BY CUSTOMER
            </h2>
            <p className="text-xl text-gray-400">
              Our Self-Services payment platforms take care of low margin and
              time-consuming tasks that drain staff and prevent it from focusing
